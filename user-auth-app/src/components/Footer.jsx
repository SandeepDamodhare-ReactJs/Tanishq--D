...
const Footer = () => {
  ...
  <footer class="bg-gray-900 p-10 font-[sans-serif] tracking-wide">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="lg:flex lg:items-center">
          <a href="javascript:void(0)">
            <img src="https://5.imimg.com/data5/SELLER/Default/2021/2/KR/OE/CT/3077590/diamond-stone-500x500.jpg" alt="logo" class="w-52" />
          </a>
        </div>
      ...
      <p class='text-gray-300 text-sm mt-10'>© 2024<a href='https://readymadeui.com/' target='_blank'
        class="hover:underline mx-1">Sandeep Damodhare</a>All Rights Reserved.
      </p>
    </footer>
